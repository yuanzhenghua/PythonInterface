...
class CtedsGroupJoin_group(object):
    
    url = "http://open.aliwap.cn:8000/cteds/group/join_group"
    ...
    def test_2(self):
        ...
        pic = ""
        times = ""
        result = {"status":"1004","msg":"已加入圈子"}
        CtedsGroupJoin_group().Implementation(param, pic, times, result)
        detailData = Interface().interface(self.url, param, pic, times, result)
        detailData["filename"] = sys._getframe().f_code.co_name
        return detailData
